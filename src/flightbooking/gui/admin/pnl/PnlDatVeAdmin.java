...
public class PnlDatVeAdmin extends JPanel {
    ...
    private void taoVe() {
        ...
        try {
            ...
            Integer taiKhoanNhanVienId = SessionContext.getNhanVienId(); // ✅ lấy từ login mock
            if (taiKhoanNhanVienId == null) taiKhoanNhanVienId = 1;

            datVeBUS.datVe(
                    null,                 // taiKhoanKhachHangId
                    taiKhoanNhanVienId,   // nhân viên quầy
                    chuyenBayId,
                    items,
    ...
    private static class ChuyenItem {
        ...
        ChuyenItem(int id, String text) { this.id = id; this.text = text; }
        @Override public String toString() { return text; }
    }

    private static class GheItem {
        final int id; final String text;
        GheItem(int id, String text) { this.id = id; this.text = text; }
        @Override public String toString() { return text; }
    }
}
